    ...
    <div className="flex w-screen flex-col items-center justify-center">
      <div className="privacy-policy max-w-(--breakpoint-xl) p-6 pt-24">
        ...
        <p className="mb-4">
          ...
          and between GAIA ("Company," "GAIA," "we," "us," or "our"), and you,
          the individual or entity accessing or using our artificial
          ...
          AGREEMENT. IF YOU DO NOT AGREE TO THESE TERMS, YOU MAY NOT ACCESS OR
          USE THE SERVICE.
        </p>
        ...
        <p className="mb-4">
          ...
          constitutes the entire agreement between you and Company concerning
          your use of the Service. You further acknowledge that you have read
          and understood our Privacy Policy, which is incorporated herein by
          reference and forms an integral part of this Agreement.
        </p>
        ...
        <p className="mb-4">
          ...
          age of majority in your jurisdiction, whichever is greater; (c) if you
          are entering into this Agreement on behalf of an entity, you have the
          authority to bind such entity; and (d) your use of the Service does
        ...
        <div className="mb-4">
          ...
          <ul className="ml-6 list-disc">
            ...
            <li>
              ...
              information during account registration and shall promptly update
        ...
        <div className="mb-4">
          ...
          <ul className="ml-6 list-disc">
            ...
            <li>
              Circumventing or attempting to circumvent any security measures or
              access controls.
            </li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="mb-4 ml-6 list-disc">
            ...
            <li>
              You authorize Company to charge your designated payment method for
          ...
          <div className="mb-4">
            ...
            <ul className="mb-4 ml-6 list-disc">
              <li>
                ...
                non-refundable, including but not limited to subscription fees,
                one-time purchases, and add-on services;
              </li>
              <li>
                <strong>Exceptional Circumstances:</strong> Refunds may be
                considered solely at Company's discretion in cases of technical
                errors, duplicate charges, or other exceptional circumstances;
              </li>
              <li>
                <strong>Legal Requirements:</strong> Where required by
                applicable consumer protection laws, refunds will be provided in
          ...
          <div className="mb-4">
            ...
            <ul className="mb-4 ml-6 list-disc">
              <li>
                <strong>Self-Service Cancellation:</strong> Use the cancellation
                functionality provided in your account settings or user
                interface, if available;
              </li>
              <li>
                <strong>Support Cancellation:</strong> Contact our support team
                at support@heygaia.so with your cancellation request;
              </li>
              <li>
                <strong>Cancellation Timing:</strong> Cancellations are
                effective at the end of your current billing cycle, and you will
          ...
          <div className="mb-4">
            ...
            <ul className="ml-6 list-disc">
              ...
              <li>
                Company reserves the right to modify or discontinue free trials
                and promotional offers at any time.
              </li>
            </ul>
          </div>
        </div>
        ...
        <p className="mb-4">
          ...
          secret, and other intellectual property laws. You are granted a
          limited, non-exclusive, non-transferable, revocable license to access
          and use the Company Content solely for your personal, non-commercial
        ...
        <p className="mb-4">
          ...
          Company's business operations. You represent and warrant that you have
        ...
        <p className="mb-4">
          ...
          discretion, that you have violated any provision of this Agreement.
          Upon termination, your right to use the Service shall immediately
          cease, and you shall discontinue all use of the Service. Sections 6,
          7, 9, 10, 11, 12, and 13 shall survive termination of this Agreement.
        </p>
        ...
        <div className="mb-4">
          ...
          <ul className="ml-6 list-disc">
            ...
            <li>
              ...
              ANY CONTENT OR INFORMATION PROVIDED THROUGH THE SERVICE.
            </li>
          </ul>
          <p className="mt-2">
        ...
        <p className="mb-4">
          ...
          USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, ARISING OUT OF OR RELATING
          ...
          THE POSSIBILITY OF SUCH DAMAGES. COMPANY'S TOTAL LIABILITY FOR ANY
          CLAIM ARISING OUT OF OR RELATING TO THIS AGREEMENT SHALL NOT EXCEED
          THE AMOUNT YOU PAID TO COMPANY FOR THE SERVICE DURING THE TWELVE (12)
          MONTHS PRECEDING THE CLAIM.
        </p>

        <h2 className="mt-6 mb-2 text-xl font-semibold">12. Indemnification</h2>
        <p className="mb-4">
          ...
          from: (a) your use of the Service; (b) your violation of this
          Agreement; (c) your violation of any third-party rights; or (d) any
        ...
        <p className="mb-4">
          ...
          Service after the effective date of any modifications constitutes your
