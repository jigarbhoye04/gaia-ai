    ...
    <div className="flex w-screen flex-col items-center justify-center">
      <div className="privacy-policy max-w-(--breakpoint-xl) p-6 pt-24">
        ...
        <div className="mb-4">
          ...
          <ul className="mb-4 ml-6 list-disc">
            <li>
              ...
              username, password, and other registration information you provide
        ...
        <div className="mb-4">
          ...
          <ul className="mb-4 ml-6 list-disc">
            <li>
              Account information: Retained while your account is active and for
        ...
        <div className="mb-4">
          ...
          <p className="mb-2">
            If you are located in the EEA, you have additional rights under the
