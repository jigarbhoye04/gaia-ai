  ...
  return (
    <div className="relative z-1 flex h-fit min-h-fit items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-1 p-2 sm:p-5">
        ...
        <MotionContainer className="my-6 grid h-fit max-w-(--breakpoint-xl) items-center justify-center gap-2 gap-y-2 rounded-2xl bg-zinc-900 px-2 py-3 sm:grid-cols-3 sm:gap-2 sm:gap-y-5 sm:rounded-3xl sm:p-10">
          {list.map((item, index) => (
            <Feature
              key={index}
