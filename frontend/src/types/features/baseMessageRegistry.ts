...
export const BASE_MESSAGE_SCHEMA = {
    ...
    calendar_delete_options: undefined as CalendarDeleteOptions[] | null | undefined,
...
export const BASE_MESSAGE_KEYS = Object.keys(BASE_MESSAGE_SCHEMA) as BaseMessageKey[]; 