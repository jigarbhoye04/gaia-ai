...
const summaryComponent = (
  <div className="rounded-xl border border-white/10 bg-slate-800/30 backdrop-blur-sm p-6">
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        <div className="rounded-lg border border-white/5 bg-slate-800/50 p-3">
          <h4 className="mb-1 text-sm font-medium text-gray-200">Core Message</h4>
          <p className="text-xs text-gray-400">
            Discusses challenges faced by founders and their journey to reapply to YC, featuring new workflow tools and startup stories.
          </p>
        </div>
        <div className="rounded-lg border border-white/5 bg-slate-800/50 p-3">
          <h4 className="mb-1 text-sm font-medium text-gray-200">Key Highlights</h4>
