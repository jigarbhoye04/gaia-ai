...
import { ChatInput } from '@/features/chat/components/livekit/chat-input';
import { Button } from "@heroui/button";
import { Toggle } from '@/components/ui/shadcn/toggle';
import { AppConfig } from '@/features/chat/components/livekit/lib/types';
import { cn } from '@/lib/utils';
import { DeviceSelect } from '@/features/chat/components/livekit/device-select';
import { TrackToggle } from '@/features/chat/components/livekit/track-toggle';
import { UseAgentControlBarProps, useAgentControlBar } from '@/features/chat/components/livekit/hooks/use-agent-control-bar';
...
export function AgentControlBar({
  ...
  return (
    <div
      ...
      className={cn(
        'dark:border-separator1 flex flex-col rounded-[31px] border p-3 drop-shadow-md/3',
        className
      )}
      {...props}
    >
