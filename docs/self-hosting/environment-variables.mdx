...
<Info>
**Infisical Integration**: GAIA supports [Infisical](https://infisical.com) for secure secret management. When configured, Infisical secrets will override local environment variables. See our [Infisical Setup Guide](/self-hosting/infisical-setup) for more details.
</Info>
...
<Note>
**Infisical Integration**: If you're using [Infisical](/self-hosting/infisical-setup) for secret management, you can add these environment variables to your Infisical project instead of the `.env` file. Infisical secrets will automatically override any local environment variables with the same names.
</Note>
...
<Note>
**Important**: If you're using Infisical, add your environment variables to your Infisical project instead. The variables below will be overridden by Infisical secrets if they have the same names. Read more about [Infisical setup](/self-hosting/infisical-setup).
</Note>
