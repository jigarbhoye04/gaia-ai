    ...
    plans_to_create = [
        {
            ...
            "plan": CreatePlanRequest(
                ...
                features=[
                    ...
                    "File uploads: 20/month",
                    "Calendar management: 10 events/month",
                    "Email actions: 10/month",
                    "AI Image generation: 5/month",
                    "Goal tracking: 3 goals max",
                    "Web search: 500/month",
                    "Deep research: 3/month",
                    "Todo operations: 500/month",
                    "Reminders: 30/month",
                    "Weather checks: 100/month",
                    "Webpage fetch: 50/month",
                    "Document generation: 10/month",
                    "Flowchart creation: 10/month",
                    "Code execution: 50/month",
                    "Google Docs operations: 20/month",
        ...
        },
        {
            ...
            "plan": CreatePlanRequest(
                ...
                features=[
                    ...
                    "File uploads: 10,000/month",
                    "Calendar management: 25,000 events/month",
                    "Email actions: 12,000/month",
                    "AI Image generation: 5,000/month",
                    "Goal tracking: 2,500 goals",
                    "Web search: 25,000/month",
                    "Deep research: 1,200/month",
                    "Todo operations: 25,000/month",
                    "Reminders: 5,000/month",
                    "Weather checks: 10,000/month",
                    "Webpage fetch: 5,000/month",
                    "Document generation: 2,500/month",
                    "Flowchart creation: 1,000/month",
                    "Code execution: 5,000/month",
                    "Google Docs operations: 2,500/month",
