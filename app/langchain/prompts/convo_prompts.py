...
Summarize the user's latest chat request in 3 to 5 words. Be ultra-concise, capturing only the core intent. No punctuation or filler. Output only the phrase.
