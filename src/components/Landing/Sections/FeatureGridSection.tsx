...
export default function Section_Grid() {
  return (
    <AnimatedSection className="relative flex h-fit min-h-screen w-screen flex-col items-center justify-center gap-10 p-5 sm:pt-0">
      ...
      <div className="relative z-[-1] w-screen max-w-screen-xl">
        ...
        <div className="relative z-[0] grid w-screen max-w-screen-xl grid-cols-1 gap-4 p-3 sm:grid-cols-3 sm:p-0">
          <ImageGeneration />
          <FlowchartDemo />
